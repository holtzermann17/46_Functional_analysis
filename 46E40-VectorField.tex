...
\usepackage{pmmeta}
\pmcanonicalname{VectorField}
\pmcreated{2013-03-22 11:59:27}
\pmmodified{2013-03-22 11:59:27}
\pmowner{mathcam}{2727}
\pmmodifier{mathcam}{2727}
\pmtitle{vector field}
\pmrecord{16}{30902}
\pmprivacy{1}
\pmauthor{mathcam}{2727}
\pmtype{Definition}
\pmcomment{trigger rebuild}
\pmclassification{msc}{46E40}
\pmsynonym{vector-valued function}{VectorField}
%\pmkeywords{vector valued function}
\pmrelated{Gradient}
\pmrelated{LeibnizNotationForVectorFields}
\pmrelated{TangentBundle}
\pmrelated{TangentSpace}
\pmrelated{PrimitiveRecursiveVectorValuedFunction}
